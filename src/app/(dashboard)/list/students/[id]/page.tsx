        ...
        <div className="w-ful xl:w-2/3">
            ...
            <div className="flex flex-col lg:flex-row gap-4">
                ...
                <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4">
                    <div className="w-1/3">
                        <Image src="https://images.pexels.com/photos/1391495/pexels-photo-1391495.jpeg?_gl=1*1wx3rz*_ga*MTc0NjgwOTQ0NC4xNzU5Mzc1MDc4*_ga_8JE65Q40S6*czE3NTkzODEzODEkbzIkZzEkdDE3NTkzODE0MTUkajI2JGwwJGgw" alt="" width={144} height={144} className="w-36 h-36 rounded-full object-cover"/>
                    </div>
                    <div className="w-2/3 flex flex-col justify-between gap-4">
                        <h1 className="text-xl font-semibold">Lu Xueqi</h1>
